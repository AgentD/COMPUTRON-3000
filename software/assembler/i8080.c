                         ...
                         const char* a1, FILE* out )
{
    ...
    case MK_4CC('L','X','I',0):   inst(0x01|reg16(a0)<<4,out);
                                  imm16(a1,out,1);                      break;
    case MK_4CC('L','D','A','X'): inst(toupper(*a0)=='D'?0x1A:0x0A,out);break;
    case MK_4CC('S','T','A','X'): inst(toupper(*a0)=='D'?0x12:0x02,out);break;
    case MK_4CC('L','D','A',0):   inst(0x3A,out); imm16(a0,out,1);      break;
    case MK_4CC('S','T','A',0):   inst(0x32,out); imm16(a0,out,1);      break;
    case MK_4CC('L','H','L','D'): inst(0x2A,out); imm16(a0,out,1);      break;
    case MK_4CC('S','H','L','D'): inst(0x22,out); imm16(a0,out,1);      break;
    ...
    case MK_4CC('J','M','P',0):   inst(0xC3,out); imm16(a0,out,1);      break;
    case MK_4CC('J','N','Z',0):   inst(0xC2,out); imm16(a0,out,1);      break;
    case MK_4CC('J','Z',0,0):     inst(0xCA,out); imm16(a0,out,1);      break;
    case MK_4CC('J','N','C',0):   inst(0xD2,out); imm16(a0,out,1);      break;
    case MK_4CC('J','C',0,0):     inst(0xDA,out); imm16(a0,out,1);      break;
    case MK_4CC('J','P','O',0):   inst(0xE2,out); imm16(a0,out,1);      break;
    case MK_4CC('J','P','E',0):   inst(0xEA,out); imm16(a0,out,1);      break;
    case MK_4CC('J','P',0,0):     inst(0xF2,out); imm16(a0,out,1);      break;
    case MK_4CC('J','M',0,0):     inst(0xFA,out); imm16(a0,out,1);      break;
    case MK_4CC('P','C','H','L'): inst(0xE9,out);                       break;
    case MK_4CC('C','A','L','L'): inst(0xCD,out); imm16(a0,out,1);      break;
    case MK_4CC('C','N','Z',0):   inst(0xC4,out); imm16(a0,out,1);      break;
    case MK_4CC('C','Z',0,0):     inst(0xCC,out); imm16(a0,out,1);      break;
    case MK_4CC('C','N','C',0):   inst(0xD4,out); imm16(a0,out,1);      break;
    case MK_4CC('C','C',0,0):     inst(0xDC,out); imm16(a0,out,1);      break;
    case MK_4CC('C','P','O',0):   inst(0xE4,out); imm16(a0,out,1);      break;
    case MK_4CC('C','P','E',0):   inst(0xEC,out); imm16(a0,out,1);      break;
    case MK_4CC('C','P',0,0):     inst(0xF4,out); imm16(a0,out,1);      break;
    case MK_4CC('C','M',0,0):     inst(0xFC,out); imm16(a0,out,1);      break;
